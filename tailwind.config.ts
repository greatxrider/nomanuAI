	...
	theme: {
		extend: {
			...
			animation: {
				...
				'hero-glow-beat': 'heroGlowBeat 3s ease-in-out infinite alternate',
				'honeycomb-current': 'honeycombCurrent 6s linear infinite'
			},
			keyframes: {
				fadeIn: {
					'0%': {
				...
				heroGlowBeat: {
					...
					'50%': {
						opacity: '0.6',
						filter: 'brightness(1.5) contrast(1.2) drop-shadow(0 0 10px rgba(245,166,35,0.6))',
						transform: 'scale(1.02)'
					}
				},
				honeycombCurrent: {
					'0%': {
						WebkitMaskPosition: '200% center',
						maskPosition: '200% center'
					},
					'100%': {
						WebkitMaskPosition: '-200% center',
						maskPosition: '-200% center'
