    ...
    >
      <div className="container-width">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 leading-relaxed max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            ...
            <div className="space-y-6 text-sm md:text-base text-gray-600 dark:text-gray-300 leading-relaxed">
              <p>
          ...
          {values.map((value, index) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white leading-tight mb-4">
                  {value.title}
                </h4>
