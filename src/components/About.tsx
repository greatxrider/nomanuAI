    ...
    <section id="about" className="section-padding bg-white">
      <div className="container-width">
        ...
        <div className="text-center mb-20">
          ...
          <p className="body-lg max-w-4xl mx-auto text-gray-600">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            ...
            <div className="space-y-6 body-md text-gray-600">
              <p>
          ...
          <div className="grid grid-cols-2 gap-6">
            {stats.map((stat, index) => {
              ...
              return (
                <div
                  key={stat.label}
                  className="card-branded p-6 text-center hover-glow animate-fade-in"
        ...
        {/* Section Divider */}
        <div className="section-divider-brand mb-16"></div>

        {/* Values Section */}
        <div className="text-center mb-12">
          <h3 className="heading-md mb-6 text-gray-900">Our Core Values</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {values.map((value, index) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 bg-primary-50 rounded-xl flex items-center justify-center mx-auto mb-6 hover-glow">
                  <IconComponent className="w-8 h-8 text-brand-orange" />
                </div>
                <h4 className="heading-sm mb-4 text-gray-900">{value.title}</h4>
