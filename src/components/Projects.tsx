...
import { ExternalLink, Github, Zap, Users, TrendingUp, Shield, MessageCircle } from "lucide-react";
  ...
  const projects = [
    {
      ...
      description: "Automated lead generation system that captures and qualifies leads 24/7 using AI algorithms",
      category: "ai-automation",
      image: "/assets/project-leadgen.jpg",
      technologies: ["Python", "OpenAI API", "Zapier", "HubSpot"],
      results: ["300% increase in lead capture", "95% qualification accuracy", "24/7 automation"],
      icon: Zap,
      link: "#",
      github: "#",
    },
    {
      ...
      description: "Seamless integration between multiple CRM systems with automated data synchronization",
      category: "integrations",
      image: "/assets/project-crm.jpg",
      technologies: ["Node.js", "Salesforce API", "Pipedrive", "Webhooks"],
      results: ["100% data accuracy", "Real-time sync", "Reduced manual work by 80%"],
      icon: Users,
      link: "#",
      github: "#",
    },
    {
      ...
      description: "Automated client onboarding workflow with document processing and progress tracking",
      category: "workflow",
      image: "/assets/project-onboarding.jpg",
      technologies: ["React", "AWS Lambda", "Document AI", "Stripe"],
      results: ["50% faster onboarding", "Zero manual errors", "100% compliance"],
      icon: TrendingUp,
      link: "#",
      github: "#",
    },
    {
      ...
      results: ["90% customer satisfaction", "24/7 support", "60% cost reduction"],
      icon: MessageCircle,
      link: "#",
      github: "#",
    },
    {
      ...
      description: "Automated compliance monitoring and security alert system for financial institutions",
      category: "security",
      image: "/assets/project-security.jpg",
      technologies: ["Python", "AWS", "SOC2", "Machine Learning"],
      results: ["100% compliance rate", "Real-time alerts", "Zero security breaches"],
      icon: Shield,
      link: "#",
      github: "#",
    },
    {
      ...
      description: "Comprehensive business process automation with analytics and performance tracking",
      category: "workflow",
      image: "/assets/project-process.jpg",
      technologies: ["Node.js", "MongoDB", "Analytics", "Dashboard"],
      results: ["40% efficiency increase", "Real-time insights", "Scalable automation"],
      icon: TrendingUp,
      link: "#",
      github: "#",
    },
      ...
      <div className="container-width relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            Explore our portfolio of AI automation solutions that have transformed businesses across industries.
          </p>
        </div>
            ...
            <button
              ...
              className={`px-6 py-3 rounded-lg font-medium transition-all duration-300 ${
                activeFilter === filter.id
                  ...
                  : "bg-white/10 backdrop-blur-sm text-white hover:text-brand-orange border border-white/20"
              }`}
            >
              {filter.label}
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => {
            ...
            return (
              <div
                key={project.id}
                className="group bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 hover:border-brand-orange/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-brand-orange/10 overflow-hidden"
        ...
        <div className="text-center mt-16">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-lg">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Let's discuss your project requirements and create a custom AI automation solution for your business.
            </p>
            <a
              href="#contact"
